...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
%>
<script type="text/javascript" src="<%=basePath%>js/common/task/taskTime.js"></script>
<style>
		.line{
			height: 25px;
			line-height: 25px;
			...
			<div data-options="region:'center',border:false" >
				<div class="easyui-tabs" data-options="fit:true,border:false">
					...
					<div title="周">
						...
						<div class="line"><input type="radio" name="week" onclick="cycle(this)"> 周期 从星期<input class="numberspinner" style="width:60px;" data-options="min:1,max:7" value="1"> - <input class="numberspinner" style="width:60px;" data-options="min:2,max:7" value="2"></div>
					...
					<table style="height: 100px;">
						<tbody>
							...
							<tr>
								...
								<td >
									<input type="text"  id ='v_day' name="v_day" class="col" value="*" readonly="readonly"/>
								</td>
								<td >
									<input type="text" name="v_mouth" class="col" value="*" readonly="readonly"/>
								</td>
								<td >
									<input type="text" id ='v_week' name="v_week" class="col" value="?" readonly="readonly"/>
								</td>
								<td >
