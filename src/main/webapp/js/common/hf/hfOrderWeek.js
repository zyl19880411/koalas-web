$(document).ready(function() {
    ...
    $('#hfOrderWeekTable').datagrid({
      ...
      //********************表格自适应start************************************************
      var header =$("#hfOrderWeekTB").next("div").find("div .datagrid-header .datagrid-htable");
    ...
    //********************查询begin************************************************
    $("#mo20ieCloWUJV7kbfICGnh3dOFhXgGPO").click(function(){
        var options = $('#hfOrderWeekTable').datagrid('options');
        options.url='order/getOrdersWeek.do';

        var hforderisme;
        if($("#hforderismeWeek").prop("checked")){
            hforderisme = 'y'
        } else{
            hforderisme = 'n'
        }

        $('#hfOrderWeekTable').datagrid('load',{
            'studentId': $("#studentIdWeek").val(),
            'studentName': $("#studentNameWeek").val(),
            'studentPhone': $("#studentPhoneWeek").val(),
            'docName': $("#docNameWeek").val(),
            'orgName': $("#orgNameWeek").val(),
            'ctime_from':getWeek(),
            'ctime_to':new Date().Format ("yyyy-MM-dd"),
    ...
    //********************导入表格begin************************************************
    $("#SLJK0LfkUZIl7ZubFbvw4f7XruKJiAxA").click(function(){
