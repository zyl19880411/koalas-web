$(document).ready(function() {
    ...
    $('#hfOrderDayTable').datagrid({
      ...
      //********************表格自适应start************************************************
      var header =$("#hfOrderDayTB").next("div").find("div .datagrid-header .datagrid-htable");
    ...
    //********************查询begin************************************************
    $("#be4r4XMsnybBqGNJSB2icfGSJ8Rx8NMB").click(function(){
        var options = $('#hfOrderDayTable').datagrid('options');
        options.url='order/getOrdersDay.do';

        var hforderisme;
        if($("#hforderismeDay").prop("checked")){
            hforderisme = 'y'
        } else{
            hforderisme = 'n'
        }

        $('#hfOrderDayTable').datagrid('load',{
            'studentId': $("#studentIdDay").val(),
            'studentName': $("#studentNameDay").val(),
            'studentPhone': $("#studentPhoneDay").val(),
            'docName': $("#docNameDay").val(),
            'orgName': $("#orgNameDay").val(),
            'ctime_from':new Date().Format ("yyyy-MM-dd"),
            'ctime_to':new Date().Format ("yyyy-MM-dd"),
    ...
    //********************导入表格begin************************************************
    $("#wmokpuP2TcaaaQkx3KmlhsoPzy6ZBNOC").click(function(){
