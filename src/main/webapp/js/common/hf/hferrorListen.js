$(document).ready(function() {
    ...
    $('#hferrorListenTable').datagrid({
      ...
      //********************表格自适应start************************************************
      var header =$("#hferrorListenTB").next("div").find("div .datagrid-header .datagrid-htable");
    ...
    //********************查询begin************************************************
    $("#1RK0xXnvogxW6cWh173psC05IUTLb4tM").click(function(){
        var options = $('#hferrorListenTable').datagrid('options');
        options.url='error/geterrorListen.do';

        var hforderisme;
        if($("#hforderismeerrorListen").prop("checked")){
            hforderisme = 'y'
        } else{
            hforderisme = 'n'
        }

        $('#hferrorListenTable').datagrid('load',{
            'studentId': $("#studentIderrorListen").val(),
            'studentName': $("#studentNameerrorListen").val(),
            'studentPhone': $("#studentPhoneerrorListen").val(),
            'docName': $("#docNameerrorListen").val(),
            'orgName': $("#orgNameerrorListen").val(),
            'ctime_from':$('#ctime_fromerrorListen').datebox('getValue'),
            'ctime_to':$('#ctime_toerrorListen').datebox('getValue'),
            "errorType":3,
    ...
    //********************导入表格begin************************************************
    $("#7J4UcHNuBPxqodqhjioJHihKsb3xGgOu").click(function(){
        ...
        url = url + "error/exporterrorListen.do?" +
            "studentId=" + $("#studentIderrorListen").val() + "&"+
            "studentName=" + $("#studentNameerrorListen").val() + "&"+
            "studentPhone=" + $("#studentPhoneerrorListen").val() + "&"+
            "docName=" + $("#docNameerrorListen").val() + "&"+
