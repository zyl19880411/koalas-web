$(document).ready(function() {
    ...
    $('#hfOrderMonthTable').datagrid({
      ...
      //********************表格自适应start************************************************
      var header =$("#hfOrderMonthTB").next("div").find("div .datagrid-header .datagrid-htable");
    ...
    //********************查询begin************************************************
    $("#LIMaBAx5dofdOvWBzOaWALJZtdmqxQRq").click(function(){
        var options = $('#hfOrderMonthTable').datagrid('options');
        options.url='order/getOrdersMonth.do';

        var hforderisme;
        if($("#hforderismeMonth").prop("checked")){
            hforderisme = 'y'
        } else{
            hforderisme = 'n'
        }

        $('#hfOrderMonthTable').datagrid('load',{
            'studentId': $("#studentIdMonth").val(),
            'studentName': $("#studentNameMonth").val(),
            'studentPhone': $("#studentPhoneMonth").val(),
            'docName': $("#docNameMonth").val(),
            'orgName': $("#orgNameMonth").val(),
            'ctime_from':getMonth(),
            'ctime_to':new Date().Format ("yyyy-MM-dd"),
    ...
    //********************导入表格begin************************************************
    $("#vLrStHizvlA3QJ8AvcmMHRgzVTFJQtnO").click(function(){
